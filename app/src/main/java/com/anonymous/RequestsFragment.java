...
public class RequestsFragment extends Fragment {
    ...
    private View requestsRragmentView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myRequestsList = (RecyclerView) requestsRragmentView.findViewById(R.id.chat_requests_list);
        myRequestsList.setLayoutManager(new LinearLayoutManager(getContext()));
        return requestsRragmentView;
    }
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        } else if (which ==1){                                                               chatRequestsRef.child(currentUserId).child(list_user_id).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            @Override
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                chatRequestsRef.child(currentUserId).child(list_user_id).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                    @Override
